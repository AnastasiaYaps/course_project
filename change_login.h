...
namespace типакурсач {
	...
	public ref class change_login : public Registration{
	public:
		change_login(void){
			login_check = "";
			InitializeComponent();
...
#pragma region Windows Form Designer generated code
		void InitializeComponent(void)	{
			...
			this->button3->Click += gcnew System::EventHandler(this, &change_login::exit);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &change_login::ch_pass);
			// 
			// textBox3
			// 
			...
			this->button2->Location = System::Drawing::Point(359, 611);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(190, 41);
			this->button2->TabIndex = 24;
			this->button2->Text = L"Выход";
			this->button2->UseVisualStyleBackColor = false;
			this->button2->Click += gcnew System::EventHandler(this, &change_login::button2_Click);
			// 
			// change_login
			// 
...
private: System::Void ch_pass(System::Object^ sender, System::EventArgs^ e) {
	login = textBox3->Text;
	if (textBox1->Text != textBox2->Text)  MessageBox::Show("Логины не совпадают!", "", MessageBoxButtons::OK);
	else {
		...
		while (dbReader->Read()) {
			...
			else  MessageBox::Show("Неправильный логин!", "", MessageBoxButtons::OK);
		}}}
